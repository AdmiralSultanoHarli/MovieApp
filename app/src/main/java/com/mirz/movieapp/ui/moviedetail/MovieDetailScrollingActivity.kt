...
import com.mirz.movieapp.databinding.ActivityMovieDetailScrollingBinding
import com.mirz.movieapp.ui.home.HomeActivity
        ...
        viewModel.movieDetailLiveData.observe(this, Observer { state ->
            when (state) {
                ...
                is State.Success -> {
                    ...
                    state.data.let {
                        dataBind.textType.text = "Type: ${it.type}"
